/*
   Simple C++ startup routine to setup runtime
*/
...
extern "C" void _esr_enter(void) noexcept __attribute__ ((naked, section(".text.metal.init.enter")));

// Define the symbols with "C" naming as they are used by the assembler
extern "C"  [[noreturn]] void _esr_start(void) noexcept;
